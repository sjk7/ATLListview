...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE IListControl_get_LabelEdit_Proxy( 
    IListControl * This,
    /* [retval][out] */ ListLabelEditConstants *pVal);


void __RPC_STUB IListControl_get_LabelEdit_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE IListControl_put_LabelEdit_Proxy( 
    IListControl * This,
    /* [in] */ ListLabelEditConstants newVal);


void __RPC_STUB IListControl_put_LabelEdit_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IListControl_StartLabelEdit_Proxy( 
    IListControl * This);


void __RPC_STUB IListControl_StartLabelEdit_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IListControl_HitTest_Proxy( 
    IListControl * This,
    FLOAT x,
    FLOAT y,
    /* [retval][out] */ IListItem **ListItem);
...
void __RPC_STUB IListControl_HitTest_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IListControl_HitTestEx_Proxy( 
    IListControl * This,
    FLOAT x,
    FLOAT y,
    /* [out] */ LONG *SubItemIndex,
...
void __RPC_STUB IListControl_HitTestEx_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE IListControl_get_DoubleBuffered_Proxy( 
    IListControl * This,
    /* [retval][out] */ VARIANT_BOOL *pVal);


void __RPC_STUB IListControl_get_DoubleBuffered_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE IListControl_put_DoubleBuffered_Proxy( 
    IListControl * This,
    /* [in] */ VARIANT_BOOL newVal);


void __RPC_STUB IListControl_put_DoubleBuffered_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IColumnHeaders_HitTest_Proxy( 
    IColumnHeaders * This,
    FLOAT x,
    FLOAT y,
    /* [retval][out] */ IColumnHeader **columnHeader);
...
void __RPC_STUB IColumnHeaders_HitTest_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
